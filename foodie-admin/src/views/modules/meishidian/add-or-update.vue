<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺账号" prop="dianpuzhanghao">
          <el-input v-model="ruleForm.dianpuzhanghao" 
              placeholder="店铺账号" clearable  :readonly="ro.dianpuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺账号" prop="dianpuzhanghao">
              <el-input v-model="ruleForm.dianpuzhanghao" 
                placeholder="店铺账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系人" prop="lianxiren">
              <el-input v-model="ruleForm.lianxiren" 
                placeholder="联系人" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="店铺介绍" prop="dianpujieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="店铺介绍"
                  v-model="ruleForm.dianpujieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dianpujieshao" label="店铺介绍" prop="dianpujieshao">
                    <span>{{ruleForm.dianpujieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招牌美食" prop="zhaopaimeishi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="招牌美食"
                  v-model="ruleForm.zhaopaimeishi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaopaimeishi" label="招牌美食" prop="zhaopaimeishi">
                    <span>{{ruleForm.zhaopaimeishi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='dianpujieshao'){
            this.ruleForm.dianpujieshao = obj[o];
	    this.ro.dianpujieshao = true;
            continue;
          }
	            	            if(o=='dianpudizhi'){
	    ...
	    this.ro.dianpudizhi = true;
            continue;
	            	            ...
	            	            if(o=='zhaopaimeishi'){
            this.ruleForm.zhaopaimeishi = obj[o];
	    this.ro.zhaopaimeishi = true;
            continue;
          }
	            	            if(o=='lianxiren'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `meishidian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meishidianCrossAddOrUpdateFlag = false;
                  this.parent.search();
