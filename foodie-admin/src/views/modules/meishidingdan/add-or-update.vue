          ...
          <el-form-item class="input" label="用户手机" prop="yonghushouji">
              <el-input v-model="ruleForm.yonghushouji" 
                placeholder="用户手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配送地址" prop="peisongdizhi">
          <el-input v-model="ruleForm.peisongdizhi" 
              placeholder="配送地址" clearable  :readonly="ro.peisongdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配送地址" prop="peisongdizhi">
              <el-input v-model="ruleForm.peisongdizhi" 
                placeholder="配送地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                zongjiage:{
                                                                                                                                                                                                                                                            get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.goumaishuliang
      }
    },
                                                                                                              },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghushouji = true;
            continue;
	            	            ...
	            	            if(o=='peisongdizhi'){
            this.ruleForm.peisongdizhi = obj[o];
	    this.ro.peisongdizhi = true;
            continue;
          }
	            	            if(o=='xiadanshijian'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yonghushouji = json.yonghushouji
                                  		...
                                  		if(json.peisongdizhi!=''&&json.peisongdizhi){
              		this.ruleForm.peisongdizhi = json.peisongdizhi
		}
                                                                                                                      } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `meishidingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meishidingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
